...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">  Izmena Testa</div>
            ...
            <div class="col-md-12">
                <form class="form-horizontal" action="<?php echo url('dodaj');?>" method="post" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <hr> <div class="row">
                            <label for="Ime" class="col-sm-2 control-label">Pitanje 5:</label>
                            <div class="col-sm-10">
                                <div  id="inputIme2" class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-ok"></i></span>
                                    <input  type="text" class="form-control" id="inputPitanje5" name="inputPitanje5" placeholder="Tekst pitanja">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div  id="inputIme2" class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-ok"></i></span>
                                    <input  type="text" class="form-control" id="inputOdgovor15" name="inputOdgovor15" placeholder="Tacan odgovor">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div  id="inputIme2" class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-ok"></i></span>
                                    <input  type="text" class="form-control" id="inputOdgovor25" name="inputOdgovor25" placeholder="Netacan odgovor">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div  id="inputIme2" class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-ok"></i></span>
                                    <input  type="text" class="form-control" id="inputOdgovor35" name="inputOdgovor35" placeholder="Netacan odgovor">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div  id="inputIme2" class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-ok"></i></span>
                                    <input  type="text" class="form-control" id="inputOdgovor45" name="inputOdgovor45" placeholder="Netacan odgovor">
